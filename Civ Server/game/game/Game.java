...
public class Game {
	...
	public Game(String title, int mapSizeX, int mapSizeY, int playersMax, int tMin, int tMax, int landPercent, String dbPath) throws IOException{
		this.id = ID++;
		...
		if(db.connect()){
			...
			gamedata = new GameData(id, gameSeed, mapSizeX, mapSizeY, playersMax, tMin, tMax, landPercent, db);
		}
		else{
